...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 z-10 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      border-gray-300/20 overflow-hidden transition-[width] duration-500 ${isOpen ? 'max-md:w-full' : 'max-md:w-0'}`}
      >
        ...
        <Link onClick={() => {scroll(0, 0); setIsOpen(false)}} to='/release'>Releases</Link>
